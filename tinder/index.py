...
def likeProfile():
    ...
    newProfile = {'name': profileName,'age':profileAge,'location':profileLocation, 'rate': 'like'}
...
def dislikeProfile():
    ...
    newProfile = {'name': profileName,'age':profileAge,'location':profileLocation, 'rate': 'dislike'}
